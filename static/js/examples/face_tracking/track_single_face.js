(function exampleCode() {
	...
	brfv4Example.updateCurrentExample = function(brfManager, imageData, draw) {
		...
		draw.drawRects(brfManager.getAllDetectedFaces(),	false, 1.0, 0x008000, 0.5);
		draw.drawRects(brfManager.getMergedDetectedFaces(),	false, 2.0, 0x008000, 1.0);
		...
		for(var i = 0; i < faces.length; i++) {
			...
			if(		face.state === brfv4.BRFState.FACE_TRACKING_START ||
				...
				draw.drawTriangles(	face.vertices, face.triangles, false, 1.0, 0x008000, 0.8);
				draw.drawVertices(	face.vertices, 2.0, false, 0x008000, 0.8);
			}
		}
	};
