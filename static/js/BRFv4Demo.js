...
var brfv4BaseURL = "/static/js/libs/brf_wasm/";
...
brfv4Example.start = function() {
	...
	brfv4Example.loader.preload([
		...
		"/static/js/libs/quicksettings/quicksettings.min.css",			// gui elements
		"/static/js/libs/quicksettings/quicksettings.js",

		"/static/js/libs/highlight/highlight_tomorrow.css",				// code highlighter
		"/static/js/libs/highlight/highlight.pack.js",

		"/static/js/libs/createjs/easeljs.min.js",						// canvas drawing lib
		"/static/js/libs/threejs/three.min.js",							// ThreeJS: a 3D engine

		"/static/js/utils/BRFv4DOMUtils.js",							// DOM handling
		"/static/js/utils/BRFv4Stats.js",								// FPS meter

		"/static/js/utils/BRFv4DrawingUtils_CreateJS.js",				// BRF result drawing
		"/static/js/utils/BRFv4Drawing3DUtils_ThreeJS.js",				// ThreeJS 3d object placement.

		"/static/js/utils/BRFv4SetupWebcam.js",							// webcam handling
		"/static/js/utils/BRFv4SetupPicture.js",						// picture/image handling
		"/static/js/utils/BRFv4SetupExample.js",						// overall example setup

		"/static/js/utils/BRFv4PointUtils.js",							// some calculation helpers

		"/static/js/utils/BRFv4SetupChooser.js",						// gui: choose either webcam or picture
		"/static/js/utils/BRFv4ExampleChooser.js",						// gui: choose an example
		"/static/js/utils/BRFv4DownloadChooser.js",						// gui: choose which package to download

		// example to load on startup, others can be chosen via the example chooser GUI.

		"/static/js/examples/face_tracking/track_single_face.js"		// start with this example
